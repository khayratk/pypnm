...
def get_drained_tubes(network, pressure, entry_pressure):
    ...
    intfc_tubes_mask = (drain_criteria_1 | drain_criteria_2 | drain_criteria_3) & (network.tubes.invaded == 0)
...
def run():
    ...
    try:
        ...
        network = structured_network(25, 50, 3)
        ...
        for niter in xrange(1000000):
            ...
            for _ in xrange(3):
                ...
                while True:
                    ...
                    pressure = petsc_solve(A * sf, q * sf, x0=pressure)
                    ...
                    for ti_drained in ti_list_drained[0:2*len(ti_list_drained)/3+1]:
                        ...
                        print "drained tube:", ti_drained
                        print "drained pores:", network.edgelist[ti_drained]
                ...
                while True:
                    ...
                    # print "length of blocked list", len(ti_list_blocked)
